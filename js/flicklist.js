...
var api = {
  ...
  token: "17d585585633f2e3903d034649a2dd61" // TODO 0 add your api key
}
...
function render() {
  ...
  model.browseItems.forEach(function(movie) {
    ...
    var button = $("<button></button>")
      ...
      a = model.watchlistItems.indexOf(movie)
      button.prop("disabled", a !== -1);
    ...
    var desc = $("<p></p>").text(movie.overview)
